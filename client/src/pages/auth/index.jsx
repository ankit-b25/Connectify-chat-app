...
const Auth = () => {
  ...
  return (
    <div className="h-[100vh] w-[100vw] flex justify-center items-center">
      <div className="h-[90vh] w-[80vw] bg-white border-2 border-white text-opacity-90 shadow-2xl md:w-[90vw] rounded-3xl grid xl:grid-cols-2">
        ...
        <div className="hidden xl:flex justify-center items-center">
          <img src={Background} alt="background login" className="h-[80vh]" />
        </div>
      </div>
    </div>
  )
